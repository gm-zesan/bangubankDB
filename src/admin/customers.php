                      ...
                      <div class="flex gap-x-4">
                        <span
                          ...
                          <span
                            ...
                            ><?php echo $user->getInitials($userData['name']); ?></span
                          >
                        </span>
                        ...
                        <div class="flex-auto min-w-0">
                          <p
                            ...
                            <a href="./customer_transactions.php?email=<?php echo $userData['email']; ?>">
                              <span
                          ...
                          <p class="flex mt-1 text-xs leading-5 text-gray-500">
                            <a
                              href="./customer_transactions.php?email=<?php echo $userData['email']; ?>"
